...
const Results = () => {
  ...
  return (
    <div className="bg-slate-900 p-10 rounded-r-xl rounded-bl-[100px] w-xl flex flex-col items-start justify-start">
      ...
      <div className="w-full border-4 border-t-primary-lime bg-[#00000040] p-8 rounded-2xl">
        ...
        <p className="text-primary-lime text-6xl font-bold">${monthly}</p>
